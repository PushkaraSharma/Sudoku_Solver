...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 30 13:33:48 2020
    ...
    try:
        ...
        if detect_guide :
            ...
            if (max([len1, len2, len3, len4]) - min([len1, len2, len3, len4])) <= 30 and min([len1, len2, len3, len4])>100:
                ...
                cv2.putText(img_original, 'Capture image - "C" Key', (30, 430), cv2.FONT_HERSHEY_COMPLEX_SMALL, 1,(0, 255, 0), 1)
        ##########################----------------------------

        cv2.putText(img_original, 'Exit video - "Q" Key', (30, 460),cv2.FONT_HERSHEY_COMPLEX_SMALL,1, (0, 0, 255), 1)
        cv2.putText(img_original, '- rishi', (530, 460),cv2.FONT_HERSHEY_COMPLEX_SMALL,1, (255, 0, 0), 1)
